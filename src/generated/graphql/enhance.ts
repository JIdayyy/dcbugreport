...
const modelsInfo = {
  ...
  Bug: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  Website: ["id", "name", "url", "created_at", "updated_at"]
};
...
const outputsInfo = {
  ...
  BugGroupBy: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "_count", "_min", "_max"],
  AggregateWebsite: ["_count", "_min", "_max"],
  WebsiteGroupBy: ["id", "name", "url", "created_at", "updated_at", "_count", "_min", "_max"],
  ...
  BugCount: ["File"],
  BugCountAggregate: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "_all"],
  BugMinAggregate: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  BugMaxAggregate: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  WebsiteCount: ["Bug"],
  WebsiteCountAggregate: ["id", "name", "url", "created_at", "updated_at", "_all"],
  WebsiteMinAggregate: ["id", "name", "url", "created_at", "updated_at"],
  WebsiteMaxAggregate: ["id", "name", "url", "created_at", "updated_at"]
};
...
const inputsInfo = {
  ...
  BugWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "userId", "Website", "websiteId", "File"],
  BugOrderByWithRelationInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "userId", "Website", "websiteId", "File"],
  BugWhereUniqueInput: ["id"],
  BugOrderByWithAggregationInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "_count", "_max", "_min"],
  BugScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  WebsiteWhereInput: ["AND", "OR", "NOT", "id", "name", "url", "created_at", "updated_at", "Bug"],
  WebsiteOrderByWithRelationInput: ["id", "name", "url", "created_at", "updated_at", "Bug"],
  WebsiteWhereUniqueInput: ["id"],
  WebsiteOrderByWithAggregationInput: ["id", "name", "url", "created_at", "updated_at", "_count", "_max", "_min"],
  WebsiteScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "url", "created_at", "updated_at"],
  ...
  BugCreateInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "File"],
  BugUpdateInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "File"],
  BugCreateManyInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  BugUpdateManyMutationInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at"],
  WebsiteCreateInput: ["id", "name", "url", "created_at", "updated_at", "Bug"],
  WebsiteUpdateInput: ["id", "name", "url", "created_at", "updated_at", "Bug"],
  WebsiteCreateManyInput: ["id", "name", "url", "created_at", "updated_at"],
  WebsiteUpdateManyMutationInput: ["id", "name", "url", "created_at", "updated_at"],
  ...
  BugCountOrderByAggregateInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  BugMaxOrderByAggregateInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  BugMinOrderByAggregateInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  WebsiteCountOrderByAggregateInput: ["id", "name", "url", "created_at", "updated_at"],
  WebsiteMaxOrderByAggregateInput: ["id", "name", "url", "created_at", "updated_at"],
  WebsiteMinOrderByAggregateInput: ["id", "name", "url", "created_at", "updated_at"],
  ...
  WebsiteUpdateOneWithoutBugInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  BugCreateWithoutUserInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "Website", "File"],
  ...
  BugScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  ...
  BugCreateWithoutFileInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website"],
  ...
  BugUpdateWithoutFileInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website"],
  ...
  WebsiteCreateWithoutBugInput: ["id", "name", "url", "created_at", "updated_at"],
  ...
  WebsiteUpdateWithoutBugInput: ["id", "name", "url", "created_at", "updated_at"],
  ...
  BugCreateWithoutWebsiteInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "File"],
  ...
  BugCreateManyUserInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "websiteId"],
  FileUpdateWithoutUserInput: ["id", "name", "path", "size", "type", "is_disabled", "created_at", "updated_at", "bug"],
  BugUpdateWithoutUserInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "Website", "File"],
  ...
  BugCreateManyWebsiteInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "userId"],
  BugUpdateWithoutWebsiteInput: ["id", "title", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "File"]
};
