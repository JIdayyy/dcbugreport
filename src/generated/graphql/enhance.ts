...
const modelsInfo = {
  ...
  Bug: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
...
const outputsInfo = {
  ...
  BugGroupBy: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  BugCount: ["File"],
  BugCountAggregate: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId", "_all"],
  BugAvgAggregate: ["number"],
  BugSumAggregate: ["number"],
  BugMinAggregate: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  BugMaxAggregate: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  WebsiteCount: ["Bug"],
...
const inputsInfo = {
  ...
  BugWhereInput: ["AND", "OR", "NOT", "id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "userId", "Website", "websiteId", "File", "categoryId", "Category"],
  BugOrderByWithRelationInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "userId", "Website", "websiteId", "File", "categoryId", "Category"],
  BugWhereUniqueInput: ["id"],
  BugOrderByWithAggregationInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId", "_count", "_avg", "_max", "_min", "_sum"],
  BugScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  ...
  BugCreateInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "File", "Category"],
  BugUpdateInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "File", "Category"],
  BugCreateManyInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  BugUpdateManyMutationInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at"],
  ...
  BugCountOrderByAggregateInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  BugAvgOrderByAggregateInput: ["number"],
  BugMaxOrderByAggregateInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  BugMinOrderByAggregateInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  ...
  BugCreateWithoutUserInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "Website", "File", "Category"],
  ...
  BugScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId", "categoryId"],
  ...
  BugCreateWithoutFileInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "Category"],
  ...
  BugUpdateWithoutFileInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "Category"],
  BugCreateWithoutCategoryInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "File"],
  ...
  BugCreateWithoutWebsiteInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "File", "Category"],
  ...
  BugCreateManyUserInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "websiteId", "categoryId"],
  FileUpdateWithoutUserInput: ["id", "name", "path", "size", "type", "is_disabled", "created_at", "updated_at", "bug"],
  BugUpdateWithoutUserInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "Website", "File", "Category"],
  BugCreateManyCategoryInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "websiteId"],
  BugUpdateWithoutCategoryInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "Website", "File"],
  ...
  BugCreateManyWebsiteInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "userId", "categoryId"],
  BugUpdateWithoutWebsiteInput: ["id", "title", "number", "description", "status", "priority", "severity", "created_at", "updated_at", "user", "File", "Category"]
};
